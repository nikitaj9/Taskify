...
let bands: string[] = [];    //explicitly defined an array of type String
bands.push("Acoustic");
console.log(bands);
...
//Tuple
let myTuple: [string, number, boolean] = ['Nikita', 32, false];
...
let myObj: object;    //Explicitly defining the type of myObject. 
...
//TS inferred the types of the properties inside this object. However, what if we explicitly want to define the types of the properies inside of an obj.

//Its something like creating our own datatype
...
// How to make a property optional. Lets say we want to make prop1 optional
/*
    let anyObj = {
        prop1?: number
        propp2: (string | number)
    }
*/

//Lets see how this feature is applied to a function
/*
const greetPrgmmers = (programmers : Programmers) => {
    return `Hello ${programmers.name}`
}
